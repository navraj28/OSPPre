...
let sols =  solution.partsRecommendation.map(function(sol) {
							  var num = parseInt(sol.partId) + 10
                              if ( sol.probablityPercentage > 75 ){
                                    return  '<div style="margin:20px 20px 20px 20px;"><span class="badge" style="background-color:green!important;width:50px;">'+sol.probablityPercentage+'%</span><span style="margin-left:20px;font-size:large;">'+sol.partName+' (Part Id '+sol.partId+')' +'</span><div style="margin-left:70px;"><p style="font-size:large;">Price: '+ num +'$</p></div></div>'
                                    }
                                      return '<div style="margin:20px 20px 20px 20px;"><span class="badge" style="background-color:blue!important;width:50px;">'+sol.probablityPercentage+'%</span><span style="margin-left:20px;font-size:large;">'+sol.partName+' (Part Id '+sol.partId+')' +'</span><div style="margin-left:70px;"><p style="font-size:large;">Price: '+ num +'$</p></div></div>'
